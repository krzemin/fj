...
\usepackage{etoolbox}
\BeforeBeginEnvironment{minted}{\begin{tcolorbox}[colback=white,arc=0mm]}
...
\begin{thebibliography}{1}
  ...
  \bibitem{fj} A. Igarashi, B. C. Pierce, P. Wadler {\em Featherweight Java: A Minimal Core Calculus for Java and GJ}  2002.
